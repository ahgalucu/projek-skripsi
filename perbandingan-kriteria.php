...
require_once './includes/Matrix.php';akses_pengguna(array(2,3));?>
...
if(!empty($_POST)){
	...
	foreach (array_keys($_POST) as $x) {
        ...
        $q->execute();
        $q = $conn->prepare("INSERT INTO bobot_kriteria VALUE ('$k1', '$k2', '{$_POST[$x]}','$periode-01-01')");
		//print_r($q);
		//die;
        $q->execute();
    }  
...
$kriteria = data_kriteria($periode);
...
for ($x=0; $x < count($kriteria); $x++) {
    for ($y=$x+1; $y < count($kriteria); $y++) {
        ...
        <table class="table table-striped">
            ...
            <tr>
                <th><label class="radio"><input class="radio" <?php if($b=='9/1') echo 'checked' ?> value="9/1" type="radio" name="<?=$kriteria[$x][0].'-'.$kriteria[$y][0]?>"required><span></span></label></th>
                <th><label class="radio"><input class="radio" <?php if($b=='8/1') echo 'checked' ?> value="8/1" type="radio" name="<?=$kriteria[$x][0].'-'.$kriteria[$y][0]?>"required><span></span></label></th>
                <th><label class="radio"><input class="radio" <?php if($b=='7/1') echo 'checked' ?> value="7/1" type="radio" name="<?=$kriteria[$x][0].'-'.$kriteria[$y][0]?>"required><span></span></label></th>
                <th><label class="radio"><input class="radio" <?php if($b=='6/1') echo 'checked' ?> value="6/1" type="radio" name="<?=$kriteria[$x][0].'-'.$kriteria[$y][0]?>"required><span></span></label></th>
                <th><label class="radio"><input class="radio" <?php if($b=='5/1') echo 'checked' ?> value="5/1" type="radio" name="<?=$kriteria[$x][0].'-'.$kriteria[$y][0]?>"required><span></span></label></th>
                <th><label class="radio"><input class="radio" <?php if($b=='4/1') echo 'checked' ?> value="4/1" type="radio" name="<?=$kriteria[$x][0].'-'.$kriteria[$y][0]?>"required><span></span></label></th>
                <th><label class="radio"><input class="radio" <?php if($b=='3/1') echo 'checked' ?> value="3/1" type="radio" name="<?=$kriteria[$x][0].'-'.$kriteria[$y][0]?>"required><span></span></label></th>
                <th><label class="radio"><input class="radio" <?php if($b=='2/1') echo 'checked' ?> value="2/1" type="radio" name="<?=$kriteria[$x][0].'-'.$kriteria[$y][0]?>"required><span></span></label></th>
                <th><label class="radio"><input class="radio" <?php if($b=='1/1') echo 'checked' ?> value="1/1" type="radio" name="<?=$kriteria[$x][0].'-'.$kriteria[$y][0]?>"required><span></span></label></th>
                <th><label class="radio"><input class="radio" <?php if($b=='1/2') echo 'checked' ?> value="1/2" type="radio" name="<?=$kriteria[$x][0].'-'.$kriteria[$y][0]?>"required><span></span></label></th>
                <th><label class="radio"><input class="radio" <?php if($b=='1/3') echo 'checked' ?> value="1/3" type="radio" name="<?=$kriteria[$x][0].'-'.$kriteria[$y][0]?>"required><span></span></label></th>
                <th><label class="radio"><input class="radio" <?php if($b=='1/4') echo 'checked' ?> value="1/4" type="radio" name="<?=$kriteria[$x][0].'-'.$kriteria[$y][0]?>"required><span></span></label></th>
                <th><label class="radio"><input class="radio" <?php if($b=='1/5') echo 'checked' ?> value="1/5" type="radio" name="<?=$kriteria[$x][0].'-'.$kriteria[$y][0]?>"required><span></span></label></th>
                <th><label class="radio"><input class="radio" <?php if($b=='1/6') echo 'checked' ?> value="1/6" type="radio" name="<?=$kriteria[$x][0].'-'.$kriteria[$y][0]?>"required><span></span></label></th>
                <th><label class="radio"><input class="radio" <?php if($b=='1/7') echo 'checked' ?> value="1/7" type="radio" name="<?=$kriteria[$x][0].'-'.$kriteria[$y][0]?>"required><span></span></label></th>
                <th><label class="radio"><input class="radio" <?php if($b=='1/8') echo 'checked' ?> value="1/8" type="radio" name="<?=$kriteria[$x][0].'-'.$kriteria[$y][0]?>"required><span></span></label></th>
                <th><label class="radio"><input class="radio" <?php if($b=='1/9') echo 'checked' ?> value="1/9" type="radio" name="<?=$kriteria[$x][0].'-'.$kriteria[$y][0]?>"required><span></span></label></th>
            </tr>
        </table><br>

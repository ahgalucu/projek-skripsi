...
<div class="card mb-4 shadow-sm" style="margin:30px auto;max-width:400px;">
    <div class="card-header">
        <h4 class="m-0 font-weight-bold text-primary"><span class="fas fa-sign-in-alt"></span> Login</h4>
    </div>
    <div class="card-body">
        <form method="post" id="form-masuk">
            <label class="m-0 font-weight-bold text-primary" for="username">Username</label>
            <input id="username" value="<?=@$username?>" name="username" class="form-control mb-2 mr-sm-2" type="text">
            <label class="m-0 font-weight-bold text-primary" for="password">Password</label>
            ...
            <button type="submit" class="btn btn-outline-primary float-right"><span class="fas fa-sign-in-alt"></span> Login</button>
        </form>
    </div>
